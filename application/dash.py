       ...
       dbc.Row(
            [
                ...
                html.P(
                   ...
                   " Entre 2015 y 2021 se registraron "+ str(f"{int(TOTHOSTSEX):,}") +" casos, lo que representa una tasa de "+
       str(TASAHOSTSEX) +" delitos por cada 100 mil habitantes. "+
                    "Este dashboard analítico se compone de una sección en la cual tratamos el hostigamiento sexual, observamos "
...
#---------Grafica mensual
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.P("Tabasco", style={"font-size": 30,"color": "black","background-color": "white"}),
                  ...
                  style={'size': 2,}),
                          html.P(
                          "Los 10 municipios con más hostigamiento sexual fueron: Centro (511), Cárdenas (93), Huimanguillo (66),"
                              " Cunduacán (51), Nacajuca (47), Centla (45), Comalcalco (38), Macuspana (37), Teapa (33) y Paraíso (31).",
               ...
               dbc.Col(dbc.Button(([html.P("Chihuahua", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Hostigamientosexual/blob/main/application/static/ch.jpeg?raw=true",
                                    style={'size': 2,}),
                       html.P(
                           "Los 10 municipios con más hostigamiento sexual fueron: Juárez (409), Chihuahua (369), Delicias (52)"
                           ", Hidalgo del Parral (48), Cuauhtémoc (37), Meoqui (17), Nuevo Casas Grandes (17), Jiménez (13), "
                           "Camargo (8) y Aldama (5).",
                              style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
                       ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
    ...
    html.Br(),
          ...
          dbc.Col(dbc.Button(([html.P("Veracruz", style={"font-size": 30,"color": "black","background-color": "white"}),
                       ...
                       html.P(
                           "Los 10 municipios con más hostigamiento sexual fueron: Xalapa (132), Veracruz (98), Coatzacoalcos (79)"
                           ", Córdoba (38), Minatitlán (23), Papantla (22), Boca del Río (20), Orizaba (20), Tuxpan (16) y Tierra Blanca (14).",
                           style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                         'margin-left': '300px',
    ...
    #[
        dbc.Row([
                ...
                html.P(
                    ...
                    "se obtuvo del Secretariado Ejecutivo Nacional del Sistema Nacional de Seguridad Pública (SENSNSP) (2015-2021); "
                    " "
